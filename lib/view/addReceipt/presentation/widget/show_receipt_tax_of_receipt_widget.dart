...
class ShowReceiptTaxOfReceiptWidget extends StatelessWidget {
  const ShowReceiptTaxOfReceiptWidget({Key? key}) : super(key: key);
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: CustomButton(
                  text: '${cubitAddReceipt.receiptModel!.service} LE',
                  fontSize: 12.sp,
                  radius: 30,
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(
                ...
                width: AppSizes.getProportionateScreenWidth(70),
                child: CustomButton(
                  text: '${cubitAddReceipt.receiptModel!.tax} LE',
                  fontSize: 12.sp,
                  radius: 30,
                  buttonColor: AppColors.grayColor2,
                  fontColor: AppColors.primaryColor,
